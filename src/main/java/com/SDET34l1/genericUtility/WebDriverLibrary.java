...
public class WebDriverLibrary
{
	 ...
	 * @param element
	 */
	public static void mouseHoverOntheElement(WebElement element,WebDriver driver1)
	{
		act = new Actions(driver1);
	 ...
	 * @param element
	 */
	public static void doubleClick(WebElement element,WebDriver driver1)
	{
		act = new Actions(driver1);
	...
	public static String takesScreenshot(String fileName,WebDriver driver1) throws IOException
	{
		...
		File dstFile = new File("./screenshot/"+fileName+"_"+jutil.dateTimeInFormat()+".png");
